...
InputBox, UserInput, Quantity, Doman Tea Lv.68 Collectible!`nModification of Kat's 1 Star RNG`nRequires 372 CP`nQuality here is way overkill for Lv.68`nHide Log Window just in case.
Loop, %UserInput%
{
