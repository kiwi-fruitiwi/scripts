...
InputBox, UserInput, Quantity, 40 Durability One CSIII under Ingenuity II`nPrecise Touch x4`nHome stretch with double Great Strides!`nRequires 396 CP. Extra Steady Hand needed to cover the Byregot at the end.
Loop, %UserInput%
{
